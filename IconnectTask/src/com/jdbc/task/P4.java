	...
	public static void main(String[] args) {
		...
		try {
			Scanner scr = new Scanner(new File(
					"C:\\Users\\arpita\\Desktop\\iconnect task/cm29JAN2020bhav.csv"));
			Scanner scr2 = new Scanner(new File(
					"C:\\Users\\arpita\\Desktop\\iconnect task/cm30JAN2020bhav.csv"));
			Scanner scr3 = new Scanner(new File(
					"C:\\Users\\arpita\\Desktop\\iconnect task/cm31JAN2020bhav.csv"));
			...
			String path = "C:\\Users\\Admin\\Desktop\\APPU\\Iconnect task/output.csv";
